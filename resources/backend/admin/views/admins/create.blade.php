...
@section('title', __('backend.admins.create'))
            ...
            <div class="page-title-box">
                <div class="btn-group pull-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('backend.admins.create')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('backend.admins.create')</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="col-6">
                        {!! Form::open([
                            'url' => route('backend.admins.store'),
                            'id' => 'form-page',
