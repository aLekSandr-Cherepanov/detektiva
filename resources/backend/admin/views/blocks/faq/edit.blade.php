...
@section('title', __('backend.blocks.edit'))
            ...
            <div class="page-title-box">
                <div class="btn-group pull-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('backend.blocks.faq.index') }}">@lang('backend.blocks.faq')</a></li>
                        <li class="breadcrumb-item active">@lang('backend.blocks.edit')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('backend.blocks.edit')</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="col-12">
                        {!! Form::model($block, [
                            'url' => route('backend.blocks.faq.update', ['faq'=> $block]),
                            'id' => 'form-page',
                        ...
                        @include('views.blocks.faq.fields')
                        {!! Form::close() !!}
                    </div>
                </div>
            </div>
