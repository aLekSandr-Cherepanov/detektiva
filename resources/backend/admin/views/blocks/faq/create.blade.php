...
@section('title', __('backend.blocks.create'))
            ...
            <div class="page-title-box">
                <div class="btn-group pull-right">
                    <ol class="breadcrumb hide-phone p-0 m-0">
                        ...
                        <li class="breadcrumb-item active">@lang('backend.blocks.create')</li>
                    </ol>
                </div>
                <h4 class="page-title">@lang('backend.blocks.create')</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-12">
            <div class="card m-b-30">
                <div class="card-body">
                    <div class="col-12">
                        {!! Form::open([
                            'url' => route('backend.blocks.faq.store'),
                            'id' => 'form-page',
